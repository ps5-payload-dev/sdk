...
```console
john@localhost:tmp$ wget https://github.com/ps5-payload-dev/sdk/releases/download/v0.16.1/ps5-payload-sdk.tar.gz
john@localhost:tmp$ mkdir -p /opt/ps5-payload-sdk-0.16.1/
john@localhost:tmp$ tar xvf ps5-payload-sdk.tar.gz -C /opt/ps5-payload-sdk-0.16.1/
```
