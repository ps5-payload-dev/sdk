...
__kernel_init(payload_args_t* args) {
  ...
  case 0x8600000:
    ...
    KERNEL_ADDRESS_TARGETID         = KERNEL_ADDRESS_DATA_BASE + 0x0AD3064 + 0x09;
    KERNEL_ADDRESS_QA_FLAGS         = KERNEL_ADDRESS_DATA_BASE + 0x0AD3064 + 0x24;
    KERNEL_ADDRESS_UTOKEN_FLAGS     = KERNEL_ADDRESS_DATA_BASE + 0x0AD3064 + 0x8C;
  ...
  case 0x9600000:
    ...
    KERNEL_ADDRESS_TARGETID         = 0; // TODO
    KERNEL_ADDRESS_QA_FLAGS         = 0; // TODO
    KERNEL_ADDRESS_UTOKEN_FLAGS     = 0; // TODO
    KERNEL_ADDRESS_PRISON0          = 0; // TODO
    KERNEL_ADDRESS_ROOTVNODE        = 0; // TODO
