...
__kernel_init(payload_args_t* args) {
  ...
  case 0x9600000:
    ...
    KERNEL_ADDRESS_PRISON0          = KERNEL_ADDRESS_DATA_BASE + 0x1E1F200; // TODO: verify offset
  ...
  case 0x10600000:
    ...
    KERNEL_ADDRESS_PRISON0          = KERNEL_ADDRESS_DATA_BASE + 0x1E1F4E0; // TODO: verify offset
