...
__kernel_init(payload_args_t* args) {
  ...
  case 0x1010000:
  case 0x1020000:
    KERNEL_ADDRESS_TEXT_BASE        = KERNEL_ADDRESS_DATA_BASE - 0xB30000;
    KERNEL_ADDRESS_ALLPROC          = KERNEL_ADDRESS_DATA_BASE + 0x36E1BF8;
    KERNEL_ADDRESS_SECURITY_FLAGS   = KERNEL_ADDRESS_DATA_BASE + 0x7251074;
    KERNEL_ADDRESS_PRISON0          = KERNEL_ADDRESS_DATA_BASE + 0x2921E00;
    KERNEL_ADDRESS_ROOTVNODE        = KERNEL_ADDRESS_DATA_BASE + 0x7575540;
    KERNEL_ADDRESS_BUS_DATA_DEVICES = KERNEL_ADDRESS_DATA_BASE + 0x2E7D478;
  ...
  case 0x1140000:
    KERNEL_ADDRESS_TEXT_BASE        = KERNEL_ADDRESS_DATA_BASE - 0xB30000;
    KERNEL_ADDRESS_ALLPROC          = KERNEL_ADDRESS_DATA_BASE + 0x36E1C18;
    KERNEL_ADDRESS_SECURITY_FLAGS   = KERNEL_ADDRESS_DATA_BASE + 0x7251074;
    KERNEL_ADDRESS_PRISON0          = KERNEL_ADDRESS_DATA_BASE + 0x2921E00;
    KERNEL_ADDRESS_ROOTVNODE        = KERNEL_ADDRESS_DATA_BASE + 0x7575540;
    KERNEL_ADDRESS_BUS_DATA_DEVICES = KERNEL_ADDRESS_DATA_BASE + 0x2E7D487;
    KERNEL_OFFSET_VMSPACE_P_ROOT    = 0x1c0;
    break;

  case 0x2000000:
    KERNEL_ADDRESS_TEXT_BASE        = KERNEL_ADDRESS_DATA_BASE - 0xB70000;
    KERNEL_ADDRESS_ALLPROC          = KERNEL_ADDRESS_DATA_BASE + 0x3711C28;
    KERNEL_ADDRESS_SECURITY_FLAGS   = KERNEL_ADDRESS_DATA_BASE + 0x73F1274;
    KERNEL_ADDRESS_PRISON0          = KERNEL_ADDRESS_DATA_BASE + 0x295BA60;
    KERNEL_ADDRESS_ROOTVNODE        = KERNEL_ADDRESS_DATA_BASE + 0x77234C0;
    KERNEL_ADDRESS_BUS_DATA_DEVICES = KERNEL_ADDRESS_DATA_BASE + 0x2DA1478;
  ...
  case 0x2700000:
    ...
    KERNEL_ADDRESS_ALLPROC          = KERNEL_ADDRESS_DATA_BASE + 0x3711C28;
    KERNEL_ADDRESS_SECURITY_FLAGS   = KERNEL_ADDRESS_DATA_BASE + 0x73F1274;
    KERNEL_ADDRESS_PRISON0          = KERNEL_ADDRESS_DATA_BASE + 0x295BD20;
    KERNEL_ADDRESS_ROOTVNODE        = KERNEL_ADDRESS_DATA_BASE + 0x77234C0;
    KERNEL_ADDRESS_BUS_DATA_DEVICES = KERNEL_ADDRESS_DATA_BASE + 0x2DA1478;
    KERNEL_OFFSET_VMSPACE_P_ROOT    = 0x1c8;
    break;
