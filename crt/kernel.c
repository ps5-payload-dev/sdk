...
unsigned long KERNEL_ADDRESS_BUS_DATA_DEVICES = 0;
...
__kernel_init(payload_args_t* args) {
  ...
  case 0x8600000:
    KERNEL_ADDRESS_TEXT_BASE        = KERNEL_ADDRESS_DATA_BASE - 0x0C60000;
    KERNEL_ADDRESS_ALLPROC          = KERNEL_ADDRESS_DATA_BASE + 0x2885D50;
    KERNEL_ADDRESS_SECURITY_FLAGS   = KERNEL_ADDRESS_DATA_BASE + 0x0AD3064;
    KERNEL_ADDRESS_PRISON0          = KERNEL_ADDRESS_DATA_BASE + 0x1E584D0;
    KERNEL_ADDRESS_ROOTVNODE        = KERNEL_ADDRESS_DATA_BASE + 0x310B510;
    KERNEL_ADDRESS_BUS_DATA_DEVICES = KERNEL_ADDRESS_DATA_BASE + 0x1FB5718;
    KERNEL_OFFSET_VMSPACE_P_ROOT    = 0x1d0;
    break;

  case 0x9000000:
    KERNEL_ADDRESS_TEXT_BASE        = KERNEL_ADDRESS_DATA_BASE - 0x0C90000;
    KERNEL_ADDRESS_ALLPROC          = KERNEL_ADDRESS_DATA_BASE + 0x2765D50;
    KERNEL_ADDRESS_SECURITY_FLAGS   = KERNEL_ADDRESS_DATA_BASE + 0x0D82064;
    KERNEL_ADDRESS_PRISON0          = KERNEL_ADDRESS_DATA_BASE + 0x1E1ED80;
  ...
  case 0x10600000:
    ...
    KERNEL_ADDRESS_ALLPROC          = KERNEL_ADDRESS_DATA_BASE + 0x2775D70;
    KERNEL_ADDRESS_SECURITY_FLAGS   = KERNEL_ADDRESS_DATA_BASE + 0x0D89064;
    KERNEL_ADDRESS_PRISON0          = KERNEL_ADDRESS_DATA_BASE + 0x1E1F4E0;
    KERNEL_ADDRESS_ROOTVNODE        = KERNEL_ADDRESS_DATA_BASE + 0x2FB3510;
    KERNEL_ADDRESS_BUS_DATA_DEVICES = KERNEL_ADDRESS_DATA_BASE + 0x1F75718;
    KERNEL_OFFSET_VMSPACE_P_ROOT    = 0x1d0; // TODO: verify offset
    break;
